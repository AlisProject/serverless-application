...
WALLET_NONCE=`aws lambda list-functions --query "Functions[?contains(FunctionName, '${ALIS_APP_ID}function02-MeWalletTokenAllhistoriesCreate')].FunctionName" --output text`
