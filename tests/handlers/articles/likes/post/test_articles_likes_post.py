...
class TestArticlesLikesPost(TestCase):
    ...
    def test_main_ok(self):
        ...
        expected_items = {
            'article_id': params['pathParameters']['article_id'],
            'user_id': params['requestContext']['authorizer']['cognito:username'],
        ...
        for key in article_liked_user_param_names:
            self.assertEqual(expected_items[key], article_liked_user_after[0][key])
